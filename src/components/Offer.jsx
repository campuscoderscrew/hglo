export default function Offer({ elem, offset }) {
    ...
    let divStyle = "max-w-[90%] w-100 p-5 sm:w-120 md:w-140 lg:w-80 lg:p-6 lg:py-12 lg:mx-4 flex flex-col items-center justify-center bg-[#86B896] rounded-lg box-border xl:transform xl:scale-110 xl:mx-8"
